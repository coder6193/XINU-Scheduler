XINU is a operating system currently being used by some embedded systems. This system is being used as aprt to our operating systems course here at NCSU.

Basic Overview:
Current XINU as priority based scheduler. Priority based schedulers have starvation problem where a lower priority process will wait forever if there are new higher priority process coming into the system.

So instead on just getting the process based on priority from the ready queue, as part of this project i implemented two scheduelers as mentioned below:
# XINU-Scheduler
1) Random Scheduler
